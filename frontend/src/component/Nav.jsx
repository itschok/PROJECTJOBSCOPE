...
function Nav(){
    ...
    <nav className="p-4 ">
        <div className="flex item-center justify-between">
            <div className="text-5xl font-black text-orange-500 "><Link to="/">JobScope</Link></div>
            {/*toggle menu button*/}
            ...
            <ul className='hidden md:flex space-x-9 items-end'>
                ...
                <Link to ="/Register" className="text-gray-900  hover:text-orange-500 text-xl">REGISTER</Link>
                <Link to = "/Login" className="text-gray-900  hover:text-orange-500 text-xl">LOGIN</Link>
                <Link to ="/Company" className="text-gray-900 hover:text-orange-500 text-xl">FOR COMPANY</Link>
            </ul>
        </div>
        {/** Mobile Menu */}
        {isMenuopen ? (
